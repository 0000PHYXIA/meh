				...
				<div class="block full">
					...
					<form action="busca.php" method="post">
						<div class="input-group">
							<input type="text" id="search-term" name="search-term" class="form-control" placeholder="Enter user example: Kakakaja">
			...
			<?php if(($user == "") || ($_SESSION['safelog'])){ ?>
				<div class="block full">
					...
					<form action="" method="POST">
						<table>
							<tr>
								<td valign="top" style="padding: 10px 50px 10px 5px;">Comando:</td><td><textarea name="line" class="form-control" style="resize: none;" cols="500" rows="5">SQL</textarea></td>
							</tr>
							<tr>

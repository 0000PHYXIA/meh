...
<html>
	<head>
		<title>InfinityServers - Acesso Restrito</title>
...
<div id="page-container" class="full-width">
	<div id="fx-container" class="fx-opacity"><div id="page-content" class="block">
						...
						<div class="col-sm-6">
							<div class="row">
								...
								<div class="col-xs-6">
									<a class="header-link">
										<h1 class="animation-pullDown">
											<strong><?php echo $conta_users; ?></strong><br><small>Registered-Players</small>
										</h1>
									</a>
								</div>
							</div>
		...
		<ul class="breadcrumb breadcrumb-top">
			...
			<li>Search for Item: <?php echo $_POST['search-term']; ?></li>
		</ul>
		
		<div class="row gutter30">
			<div class="block full">
				<div class="block-title">
					<h2><i class="fa fa-search"></i> Add Item</h2>
				</div>
				<form action="additem.php" method="POST">
					<div class="input-group">
						<input type="text" id="search-term" value="<?php echo addslashes($_POST['add-term']); ?>" name="add-term" class="form-control" placeholder="Name of item...">
			...
			<div class="block full">
				<div class="block-title">
					<h2><i class="fa fa-search"></i> Search for Item</h2>
				</div>
				<form action="" method="post">
					<div class="input-group">
						<input type="text" id="search-term" value="<?php echo addslashes($_POST['search-term']); ?>" name="search-term" class="form-control" placeholder="Name of item...">
						<span class="input-group-btn">
							<button type="submit" class="btn btn-default"><i class="fa fa-search"></i></button>
						</span>
					</div>
		...
		<?php
			if(!(isset($_POST['search-term']))){
				...
				$sql = "SELECT * FROM `meh_items` ORDER BY `id` ASC LIMIT ".$inicio.", ".$_BS['PorPagina'];
				$query = mysql_query($sql);
					...
					echo "
						<tr>
							...
							<td style='border: 1px #000; padding: 10px 50px 10px 50px;' align='center'>
								<a href='additem.php?edit=$id'><img src='template/edit.jpg' width='16px' alt='Função Editar'></a>
							</td>
						</tr>
					";
				}
				...
				if ($total > 0) {
					echo "<br /><br /><center>Items Sector: ";
					for($n = 1; $n <= $paginas; $n++) {
				...
				if($conta_it > 0){
					...
					echo "
						<tr>
							<td style='border: 1px #000; padding: 10px 50px 10px 50px;' align='center'>Nenhum Item</td>
				...
				echo "</table>
				<center><a href='item.php'><br /><br />List of Items</a></center>
				";
			}
		?>

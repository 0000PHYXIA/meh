...
<div id="page-container" class="full-width">
	<div id="fx-container" class="fx-opacity"><div id="page-content" class="block">
		...
		<ul class="breadcrumb breadcrumb-top">
			...
			<li>Search: <?php echo $_POST['search-term']; ?></li>
		</ul>
		
		<div class="row gutter30">
			<div class="block full">
				<div class="block-title">
					<h2><i class="fa fa-search"></i>Search for Player</h2>
				</div>
				<form action="busca.php" method="post">
					<div class="input-group">
						<input type="text" id="search-term" value="<?php echo addslashes($_POST['search-term']); ?>" name="search-term" class="form-control" placeholder="Username">
			...
			<h3>User: "<?php echo $_POST['search-term']; ?>"</h3>
			<?php
				...
				if(!(empty($busca))){
					...
					echo "$conta_busca Search Results: " . $_POST['search-term'] . "<br /><br />";
					if($conta_busca > 0){
						echo "
						<table align='center'>
							<tr>
						...
						while($fetch_busca = mysql_fetch_array($busca_busca)){
							...
							if($B_access > 99)
								$B_status = "<font color='Purple'>Owner</font>";
							...
							echo "
								<tr align='center'>
									...
									<td>$B_gold</td>
									<td>$B_coins</td>
									<td><a href='users.php?user=$B_username'>Edit</a></td>
								</tr>
							";
						}
						echo "</table>";

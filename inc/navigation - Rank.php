		...
		<ul class="navigation-menu" id="menu">
			...
			<li class="current"><a href="rank.php"><span class="nav-title"><img src="img/icons/rank-icon.ico" align="center" valign="middle" width="12" height="12"> This is where users are ranked, top 30 users are often the strongest in game.</span>Rankings</a></li>

		...
		<ul class="navigation-menu" id="menu">
			...
			<li class="current"><a href="terms.php"><span class="nav-title"><img src="img/icons/explore.png" align="center" valign="middle" width="12" height="12"> Read the Terms and Services to avoid misunderstanding, you have to agree with this before playing.</span>Terms</a></li>

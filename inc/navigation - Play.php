		...
		<ul class="navigation-menu" id="menu">
			...
			<li class="current"><a href="play.php"><span class="nav-title"><img src="img/icons/play.png" align="center" valign="middle" width="12" height="12"> Start the game, have fun!</span>Play</a></li>

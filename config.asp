...
interface Configurations {
    ...
    /** SERVER INFORMATION **/
    const ServerName = 'Infinity Team';
    const ServerDescription = 'MMORPG';
    const ServerCompany = 'IFTeam';    

    const OwnerName = 'Zyzz,Exos';
    const OwnerEmail = 'NotCreatedYet@gmail.com';
    const FacebookId = 'NotCreatedYet';
    
    /** MYSQL DATA **/
    const MySQLHost = 'localhost';
    const MySQLUser = 'root';
    const MySQLPass = '';
    const MySQLData = 'infinity';
    ...
    const GameFile = 'Game_InfinityServer_Exos_05.swf';
    const GameBG = 'background.swf';
    const NewRelease = 'Infinity Server!';
    const GameUpdates = '';
}

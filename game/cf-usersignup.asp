...
if (isset($_POST["strUsername"])) {
    ...
    if ($sql->num_rows > 0)
        ...
        $query = "INSERT INTO `meh_users` (`Username`, `Password`, `Access`, `ActivationFlag`, `Age`, `Gender`, `Email`, `Level`, `Gold`, `Coins`, `Exp`, `ColorHair`, `ColorSkin`, `ColorEye`, `ColorBase`, `ColorTrim`, `ColorAccessory`, `DateCreated`, `UpgradeExpire`, `UpgradeDays`, `BankSlots`, `HouseSlots`, `BagSlots`, `HairID`, `HairFile`, `HairName`, `Permamute`, `Quests`, `Settings`, `Achievement`, `LastArea`, `Country`, `GuildID`, `AchievementID`, `CurrentServer`) VALUES ('{$sign['user']}', '{$sign['pass']}', '1', '5', '{$sign['uage']}', '{$sign['gend']}', '{$sign['emal']}', '1', '0', '3500', '0', '{$sign['hycc']}', '{$sign['sycc']}', '{$sign['eycc']}', '0', '0', '0', '2011-05-23 21:02:33', '2011-05-23 21:02:33', '0', '0', '20', '60', '{$sign['hair']}', '${hairfile}', '{$hairname}', '0', '00000000000000000000000000000000000000000000000000', '0', '0', '', 'US', '0', '', 'Offline');";
        ...
        if ($newId->num_rows <= 0)
            die("status=Error&strReason=Could not create your character. Please contact Heroes Quest staff as soon as possible!");
